...
<html>
	...
	<body>
		<a href="#show-registroNovedad" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="show-registroNovedad" class="content scaffold-show" role="main">
			...
			<ol class="property-list registroNovedad">
			...
			<g:form url="[resource:registroNovedadInstance, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					<g:link class="edit" action="edit" resource="${registroNovedadInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
